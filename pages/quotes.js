...
import { quotesPushingforward, quotesVeritas } from '@/data/quotesData'
      ...
      <div className="mx-auto max-w-2xl">
        ...
        >
          ...
          <div className="relative h-64 w-full overflow-hidden rounded-md">
            <Image
              src="/static/images/Quotes/stars.jpg"
              alt="Soldier's Field"
              layout="fill"
              objectFit="cover" // You can use 'cover' to fill the width and height while maintaining aspect ratio
            />
          </div>

          {quotesPushingforward.map((item) => (
        ...
        >
          ...
          <div className="relative h-64 w-full overflow-hidden rounded-md">
            <Image
              src="/static/images/Quotes/veritas.png"
              alt="Soldier's Field"
              layout="fill"
              objectFit="cover" // You can use 'cover' to fill the width and height while maintaining aspect ratio
            />
